...
public class   TesTDetailsToSyn {
    ...
    private String report_ref_img_name;
    ...
    public String getReport_ref_img_name() {
    ...
    public void setReport_ref_img_name(String report_ref_img_name) {
